...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "freudenthal-suspension-canonical-lane",
  theoremObject := "Freudenthal Suspension Theorem",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleSuspensionClass, ConstrainedFreudenthalClosure A

theorem theorem_specific_endgame_pilot_checked : theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_freudenthal_endgame A
